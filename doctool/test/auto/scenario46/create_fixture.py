"""
S46 テストフィクスチャ生成スクリプト（条件付合格 閾値超過 → 不合格 検証）
...
【DetermineReviewResult の動作（S46 で期待される動作）】
  - CbConditional = True
  - j カテゴリの件数 = 4（> 0）
...
def main():
    ...
    dst_design = S46_DIR / "システム機能設計書_サンプル_S46.xlsx"
    ...
    dst_summary = S46_DIR / "レビュー記録サマリ_S46.xlsx"
