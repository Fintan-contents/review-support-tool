...
**例（doctool）**:
```cmd
python scripts\extract_vba.py ..\doctool\Excel設計書レビュー指摘事項抽出ツール\Excel設計書レビュー指摘事項抽出ツール.xlsm ..\doctool\vba_modules
```

**例（prtool）**:
```cmd
python scripts\extract_vba.py ..\prtool\プルリクエストコメント抽出ツール\プルリクエストコメント抽出ツール.xlsm ..\prtool\vba_modules
```
...
**例（doctool）**:
```cmd
python scripts\build_vba.py ..\doctool\vba_modules ..\doctool\Excel設計書レビュー指摘事項抽出ツール\Excel設計書レビュー指摘事項抽出ツール.xlsm
```

**例（prtool）**:
```cmd
python scripts\build_vba.py ..\prtool\vba_modules ..\prtool\プルリクエストコメント抽出ツール\プルリクエストコメント抽出ツール.xlsm
```
